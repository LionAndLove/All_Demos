package com.jikeh.dubbo.invoker.bytecode;
...
import com.jikeh.dubbo.invoker.common.ReflectUtils;
...
public final class ClassGenerator {
    ...
    public Class<?> toClass() {
        ...
        try {
            ...
            return mCtc.toClass(Thread.currentThread().getContextClassLoader(), null);
